	...
	class btnConfirm: RscShortcutButton
{
	...
	colorBackground2[] = {0.4,0.4,0.4,1}; 
	colorBackgroundFocused[] = {0.4,0.4,0.4,1};
	onButtonClick  = "[] call dia_vic_guiCreate;";
...
{
	idc = 7;
	onLBSelChanged  = "[] spawn dia_vic_guiInfo;";
	colorText[] = {1,1,1,1};
	...
	class btnLand: RscShortcutButton
{
	...
	colorBackground2[] = {0.4,0.4,0.4,1}; 
	colorBackgroundFocused[] = {0.4,0.4,0.4,1};
	onButtonClick  = "[""Car""] call CGQC_gui_LoadVeh;";
	x = 0.5025 * safezoneW + safezoneX;
	y = 0.3125 * safezoneH + safezoneY;
	w = 0.0775 * safezoneW;
	h = 0.0375 * safezoneH;
	...
	class btnSea: RscShortcutButton
{
	...
	colorBackground2[] = {0.4,0.4,0.4,1}; 
	colorBackgroundFocused[] = {0.4,0.4,0.4,1};
	onButtonClick  = "[""Ship""] call CGQC_gui_LoadVeh;";
	...
	class btnAir: RscShortcutButton
{
	...
	colorBackground2[] = {0.4,0.4,0.4,1}; 
	colorBackgroundFocused[] = {0.4,0.4,0.4,1};
	onButtonClick  = "[""Air""] call CGQC_gui_LoadVeh;";
