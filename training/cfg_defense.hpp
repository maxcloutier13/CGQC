...
_action = [ "menu_self_training_defense_on", "Start: Normal", "", {["start"] execVM '\cgqc\functions\fnc_trainingDefense.sqf'}, {true} ] call ace_interact_menu_fnc_createAction;
...
_action = [ "menu_self_training_defense_off", "Defense Training-> OFF", "", {["stop"] execVM '\cgqc\functions\fnc_trainingDefense.sqf'}, {cgqc_training_defense} ] call ace_interact_menu_fnc_createAction;
