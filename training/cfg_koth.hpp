...
_action = [ "menu_self_training_koth_stop", "Stop KOTH", "", {["stop"] call fnc_trainingKOTH}, {cgqc_training_koth} ] call ace_interact_menu_fnc_createAction;       
...
_action = [ "menu_self_training_koth_1", "Start KOTH!", "", {["start"] call fnc_trainingKOTH}, {true} ] call ace_interact_menu_fnc_createAction;       
_adding = [ player, 1, ["ACE_SelfActions", "menu_self_training", "menu_self_training_koth"], _action ] call  ace_interact_menu_fnc_addActionToObject;
