...
// Infantry ===============================================================
case "pmct_rifle":{
	[player, "pmct_rifle", ""] call CGQC_ldt_pmct_variants;
...
// Junior Specialists ===============================================================
case "pmct_lifesaver":{
	[player, "pmct_lifesaver", ""] call CGQC_ldt_pmct_variants;
...
// Medic/Eng ===============================================================
case "pmct_medic":{
	[player, "pmct_medic", ""] call CGQC_ldt_pmct_variants;
...
case "pmct_eng":{
	[player, "pmct_eng", ""] call CGQC_ldt_pmct_variants;
...
// AT ===============================================================
case "pmct_at":{
	[player, "pmct_at", ""] call CGQC_ldt_pmct_variants;
...
case "pmct_drone":{
	[player, "pmct_drone", ""] call CGQC_ldt_pmct_variants;
	["recon", true, true] spawn CGQC_fnc_switchPerks;
	//["recon"] call CGQC_fnc_getRadioPresets;
