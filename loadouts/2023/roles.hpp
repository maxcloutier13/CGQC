...
case "2023_rifle_life":{
	...
	["lifesaver"] spawn CGQC_fnc_switchPerks;
	["inf"] call CGQC_fnc_getRadioPresets;
...
case "2023_h_pilot":{
	...
	["heli"] spawn CGQC_fnc_switchPerks;
...
case "2023_h_crew":{
	...
	["heli_crew"] spawn CGQC_fnc_switchPerks;
	["pilot"] call CGQC_fnc_getRadioPresets;
...
case "2023_t_driver":{
	...
	["driver"] spawn CGQC_fnc_switchPerks;
...
case "2023_t_crew":{
	...
	["tank_crew"] spawn CGQC_fnc_switchPerks;
	["driver"] call CGQC_fnc_getRadioPresets;
