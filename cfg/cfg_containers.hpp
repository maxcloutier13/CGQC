...
class cgqc_box_mk1_supplies_team : Box_NATO_Wps_F
{
    scope = 2;
    author = "silent1";
    _generalMacro = "cgqc_box_mk1_supplies";
    displayName = "CGQC Supply - Fireteam";
    maximumLoad = 1500;
    hiddenSelectionsTextures[] = {
        "\CGQC\containers\cgqc_box_mk1_supplies.paa",
        "\CGQC\containers\cgqc_box_mk1_ammobox.paa"
...
// Explosives
class cgqc_box_mk1_explosives : Box_NATO_AmmoOrd_F
{
    scope = 2;
    author = "silent1";
    _generalMacro = "cgqc_box_mk1_explosives";
    displayName = "CGQC Explosives box";
    maximumLoad = 3000;
    /*hiddenSelectionsTextures[] = {
        "\CGQC\containers\cgqc_box_mk1_supplies.paa",
        "\CGQC\containers\cgqc_box_mk1_ammobox.paa"
