...
switch (_type) do {
    ...
    case "start": {
        ...
        if (missionNamespace getVariable "CGQC_gamestate_mission_AIpaused") then {
            [0,{["unpause", 0, ""] spawn CGQC_fnc_perksZeus}] call CBA_fnc_globalExecute;
            hint "AI Unpaused!";
        };
        // Start message for everyone
        _text = ("<br/><br/><br/><t size='1' >Mission Started!<br/>Player Snapshot saved<br/>Good luck, Viper!</t><br/>");
