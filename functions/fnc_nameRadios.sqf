...
switch (_type) do{
	case 0: { 
		...
		["ACRE_PRC152", "Default", 6, "description", cgqc_config_ch5] call acre_api_fnc_setPresetChannelField;
		["ACRE_PRC152", "Default", 7, "description", cgqc_config_ch6] call acre_api_fnc_setPresetChannelField;
		["ACRE_PRC152", "Default", 8, "description", cgqc_config_ch7] call acre_api_fnc_setPresetChannelField;
		["ACRE_PRC152", "Default", 9, "description", cgqc_config_ch9] call acre_api_fnc_setPresetChannelField;
