...
["cgqc_config_supply_ammo", "SLIDER",["Ammo bandoliers", "Number in supply box"],
    [_menu_name, "Content: Fireteam Supply Box"], [0, 50, 15, 0], 1, {publicVariable "cgqc_config_supply_ammo"}, false] call CBA_fnc_addSetting;
["cgqc_config_supply_ifak", "SLIDER",["Kit: Individual First-Aid", "Number in supply box"],
    [_menu_name, "Content: Fireteam Supply Box"], [0, 50, 15, 0], 1, {publicVariable "cgqc_config_supply_ifak"}, false] call CBA_fnc_addSetting;
["cgqc_config_supply_medkit", "SLIDER",["Kit: Medic Supply", "Number in supply box"],
    [_menu_name, "Content: Fireteam Supply Box"], [0, 50, 2, 0], 1, {publicVariable "cgqc_config_supply_medkit"}, false] call CBA_fnc_addSetting;

["cgqc_config_supply_launcher", "SLIDER",["Launchers", "Number in supply box"],
    [_menu_name, "Content: Fireteam Supply Box"], [0, 5, 2, 0], 1, {publicVariable "cgqc_config_supply_launcher"}, false] call CBA_fnc_addSetting;
["cgqc_config_supply_nlaw", "SLIDER",["NLAW", "Number in supply box"],
    [_menu_name, "Content: Fireteam Supply Box"], [0, 5, 0, 0], 1, {publicVariable "cgqc_config_supply_nlaw"}, false] call CBA_fnc_addSetting;

["cgqc_config_supply_batteries", "SLIDER",["Batteries", "Number in supply box"],
    [_menu_name, "Content: Fireteam Supply Box"], [0, 10, 1, 0], 1, {publicVariable "cgqc_config_supply_batteries"}, false] call CBA_fnc_addSetting;
["cgqc_config_supply_radios", "SLIDER",["Radios", "Number in supply box"],
    [_menu_name, "Content: Fireteam Supply Box"], [0, 10, 1, 0], 1, {publicVariable "cgqc_config_supply_radios"}, false] call CBA_fnc_addSetting;
