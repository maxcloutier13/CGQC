...
//_menu_name = "AA_CGQC";
//Intro Stuff
["cgqc_config_author", "EDITBOX", ["Auteur:", "Créateur"], 
[_menu_name, "Intro"], "Cpl. Quelque chose", 1, {}, true] call CBA_fnc_addSetting;

["cgqc_config_mission_name", "EDITBOX", ["Nom de la mission:", "Le nom du ta mission, pour display dans l'intro"], 
    [_menu_name, "Intro"], "Le nom de ta mission", 1, {}, true] call CBA_fnc_addSetting;
