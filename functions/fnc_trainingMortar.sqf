...
[_type] spawn {
	...
	switch (_type) do
	{
		case "easy":	{
			...
			["start"] call CGQC_fnc_trainingMortar;
			["items_advanced"] call CGQC_fnc_trainingMortar;
		};
		case "normal":	{
		...
		case "hard":	{
			...
			["start"] call CGQC_fnc_trainingMortar;
			["items_basic"] call CGQC_fnc_trainingMortar;
		};
		case "items_basic": {
		...
		case "stop":	{
			...
			["clear"] call CGQC_fnc_trainingMortar;
		};
		case "clear": {
			// Delete markers
